...
const Membership = props => (
  <div style={{ backgroundColor: '#8e774d' }}>
    ...
    <MDBContainer style={{ backgroundColor: '#fafafa' }}>
      ...
      <br />
      <b>Dependent:</b> Those ages 2-17 can be added to the primary member's account.
      <br />
      <br />
      <br />
      <MDBTable style={{ backgroundColor: '#efebe9' }}>
      ...
      <b>Dependent:</b> Those ages 2-17 can be added to the primary member's account.
      <br />
      <b>Payroll Deduction</b> — Faculty and staff with 12- or 9-month appointments may pay for annual spouse/dependents Rec Center
      membership through payroll deduction, where fees are automatically deducted from the employee’s paycheck in accordance with the
      university schedule. A payroll deduction form must be completed and signed when submitting a membership application.
      <br />
      <br />
      <br />
      <MDBTable style={{ backgroundColor: '#efebe9' }}>
      ...
      <b>Secondary:</b> individuals 18 and older who live in the same residence as the primary member can be added to their account.
      <br />
      <b>Dependent:</b> Those ages 2-17 can be added to the parent/legal guardian member's account. account.
      <br />
      <br />
      <br />
      <a>
      ...
      <br />
      <p>
        Eligible affiliates, who do not wish to join the Rec Center as a full member, may purchase a 10-entry mini-pass for $80. The
        purchaser must be eligible to purchase a full membership. Mini-Passes expire one year from purchase date, are for individual use
        only and are non-transferable. Mini-Passes do not include entry to GroupX classes but are eligible for single class passes.
      </p>
      <br />
      <a>
        <b>Refund</b>
      ...
      <br />
      <p>
        Refunds are issued for medical or relocation purposes only. All requests must be submitted in writing to the Rec Center Director.
        All key fobs (if applicable) must be surrendered before a refund will be made. Refunds take about three to four weeks to process and
