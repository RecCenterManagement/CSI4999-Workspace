        ...
        <Tabs>
          ...
          <TabPanel>
            ...
            <p>
              ...
              <ul>
                <li>
                  <p>
                    There is no facility rental charge to OU Departments for facility usage as long as the activity is university related
                    (business meetings, class, etc) and within posted operational hours.
                  </p>
                </li>
                <li>
                  <p>
                    OU Departments requesting space for non-university related activities or space outside normal operational hours will be
                    assessed the internal facility rental rate.
                  </p>
                </li>
                <li>
            ...
            <p>
              ...
              <ul>
                <li>
                  <p>
                    There is no facility rental charge for OU Student Organizations/Club Sports for approved requests that are part of the
                    organization's/club’s normal activity (practice, meeting, etc) for organization/club members.
                  </p>
                </li>
                <li>
                  <p>
              ...
              <p>
                <b>OU Student Organizations</b>
                <p>
                  Non-University groups wishing to use an area of the facility may request to do so pending space availability. Appropriate
                  external rental rates apply.
                </p>
              </p>
            </p>
            <MDBTable striped>
          ...
          <TabPanel>
            <ul>
              <li>
                <p>
                  There are no facility rental charges to OU Departments for facility usage as long as the activity is university related
                  (business meetings, class, etc) and within posted operational hours.
                </p>
              </li>
              <li>
                <p>
                  OU Departments requesting space for non-university related activities or space outside normal operational hours will be
                  charged the internal rental rate.
                </p>
              </li>
              <li>
            ...
            <Accordion>
                  ...
                  <Card.Body>
                    <p>
                      ...
                      <ul>
                        ...
                        <li>
                          <p>Non-Students/Non-Members need to provide Picture ID and be on the sponsoring department supplied roster.</p>
                        </li>
                      </ul>
                    </p>
                    <p>
                      ...
                      <ul>
                        <li>
                          <b>Academic Class - </b>
                          <p>
                            Students MUST swipe OU ID to gain access to facility, class Instructors names must be provided to the facility
                            contact in advance, instructors must show OU ID to Welcome Center Staff to gain entry into the facility.
                          </p>
                        </li>
                        <li>
                          <b>OU Departments - </b>
              ...
              <Card>
                ...
                <Accordion.Collapse eventKey="1">
                  <Card.Body>
                    <p>
                      Staffing needs are determined by RecWell Staff based on the activity. General guidelines to assist in planning are as
                      follows:
                    </p>
                    <ul>
                      <li>
                        <p>
                          Events using only one space during normal operational hours and having under 75 participants do not require any
                          staff unless requested beyond the organization reserving the space.
                        </p>
                      </li>
                      <li>
                        <p>
                          Events using only one space outside of normal operational hours and having under 150 participants will require 1
                          RecWell Building Manager and 1 RecWell Event Attendant.
                        </p>
                      </li>
                      <li>
                        <p>
                      ...
                      <li>
                        <p>
                          Events using more than one space outside of normal operational hours will require 1 RecWell Event Attendant per 75
                          participants or fraction thereof and 1 RecWell Building Manager. Minimum staffing level is 1 RecWell Building
                          Manager and 1 RecWell Attendant. Note: RecWell Building Manager does count as 1 staff member in the 1:75 staffing
                          ratio.
                        </p>
                      </li>
                      <li>
          ...
          <TabPanel>
            <ul>
              ...
              <li>
                <p>
                  There are no facility rental charges for OU Student Organization/Club Sports for approved requests that are part of the
                  organization/club’s normal activity (practice, meeting, etc).
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  Special Events such as tournaments and conferences or any other activity that invites non club members will be treated as
                  ‘non-related’ events and will be assessed the internal facility rental rates.
                </p>
              </li>
              <li>
                <p>
                  Student Organizations/Club Sports must submit a roster of active members at the beginning of each semester, or upon their
                  first facility request of each semester.
                </p>
              </li>
              <li>
                <p>
          ...
          <TabPanel>
            <ul>
              ...
              <li>
                <p>
                  Any approved request for a full day or multiple day event will require an event preparation meeting with a Professional
                  Staff Member.
                </p>
              </li>
              <li>
                <p>
                  If requesting use of all facilities of a particular nature (i.e. all three gym courts) for an entire day(s), provisions
                  will need to be made to make one portion of the facility available for recreational use for a 2 hour time block during the
                  day(s). This 2 hour block of time will be designated by Department staff based on recreational use patterns.
                </p>
              </li>
              <li>
                ...
                <Accordion.Collapse eventKey="0">
                  <Card.Body>
                    <ul>
                      <li>
                        <p>
                          External Groups must have general liability insurance and/or excess umbrella insurance in an amount totaling no
                          less than $1,000,000 per occurrence and $1,000,000 aggregate, and no more than $250,000 deductible per occurrence.
                          The Certificate of Insurance should name 'Oakland University and Board of Trustees' as additionally insured on the
                          policy.
                        </p>
                      </li>
                      <li>
                        <p>
                          External Groups must also have workers compensation insurance at the statutory amount and $1,000,000 of employer’s
                          liability insurance. The Certificate of Insurance should name 'Oakland University' as a certificate holder.
                        </p>
                      </li>
                      <li>
                        <p>
                    ...
                    <p>
                      <ul>
                        ...
                        <li>
                          <b>SPECIFIC - </b>
                          <p>
                            Roster of Attendees must be provided to the Facility Coordinator 1 week in advance, access is limited to those
                            on the roster. Attendees must show picture ID to Welcome Center Staff to gain entry into the facility.
                            <br />
                            <br />
                  ...
                  <Card.Body>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            Non-Refundable Reservation Deposit of 10% of Estimated Facility Charges due at receipt of confirmation to hold
                            reservation.
                          </li>
                          <li>Deposit of 50% of Estimated Facility Charges due 1 month prior to reservation.</li>
                        </ul>
                ...
                <Accordion.Collapse eventKey="3">
                  <Card.Body>
                    <ul>
                      ...
                      <li>
                        <p>
                          Cancellations made between 2-7 days prior to the reservation will be charged full estimated facility charges that
                          were indicated in the confirmation.
                        </p>
                      </li>
                      <li>
                        <p>
                          Cancellations day of or no-shows will be charged all estimated charges (facility, staffing, setup, teardown, etc.)
