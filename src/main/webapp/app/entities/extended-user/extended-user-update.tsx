    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="recCenterManagementApp.extendedUser.home.createOrEditLabel">
              <Translate contentKey="recCenterManagementApp.extendedUser.home.createOrEditLabel">Create or edit a ExtendedUser</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : extendedUserEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="badActorLabel" check>
                    <AvInput id="extended-user-badActor" type="checkbox" className="form-control" name="badActor" />
