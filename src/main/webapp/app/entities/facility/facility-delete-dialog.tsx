  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="recCenterManagementApp.facility.delete.question">
          <Translate contentKey="recCenterManagementApp.facility.delete.question" interpolate={{ id: facilityEntity.id }}>
