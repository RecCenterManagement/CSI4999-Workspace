  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="recCenterManagementApp.equipment.delete.question">
          <Translate contentKey="recCenterManagementApp.equipment.delete.question" interpolate={{ id: equipmentEntity.id }}>
